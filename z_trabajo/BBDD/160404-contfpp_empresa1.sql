...
INSERT IGNORE INTO `presupuestos` (`IdPresupuesto`, `NumPresupuesto`, `IdCliente`, `FechaPresupuesto`, `FechaVtoPresupuesto`, `FormaPago`, `FechaFinalizacion`, `Estado`, `Retencion`, `Proforma`, `Borrado`) VALUES
	(1, '20160001', '1', '2016-04-04 21:16:11', '2016-04-04 21:16:22', NULL, NULL, NULL, 0, 0, 1);
...
-- Volcando datos para la tabla contfpp_empresa1.presupuestosdetalle: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla contfpp_empresa1.productos: ~4 rows (aproximadamente)
