...
-- Volcando datos para la tabla contfpp_empresa2.facturas: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla contfpp_empresa2.facturasdetalle: ~1 rows (aproximadamente)
...
INSERT IGNORE INTO `presupuestos` (`IdPresupuesto`, `NumPresupuesto`, `IdCliente`, `FechaPresupuesto`, `FechaVtoPresupuesto`, `FormaPago`, `FechaFinalizacion`, `Estado`, `Retencion`, `Proforma`, `Borrado`, `BaseImponible`, `Cuota`, `CuotaRetencion`, `total`, `Facturada`, `Pedido`) VALUES
	...
	(2, '20162', '15', '2016-05-17 19:32:46', '2016-05-17 19:32:46', '', NULL, 'Aceptado', 14, 'NO', 1, 8440, 1772.4, 1181.6, 9030.8, 'P', 'NP');
