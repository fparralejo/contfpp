...
INSERT IGNORE INTO `empresas` (`IdEmpresa`, `Nombre`, `Password`, `identificacion`, `CIF`, `fechaAlta`, `fechaVencimiento`, `direccion`, `municipio`, `provincia`, `CP`, `telefono`, `email1`, `email2`, `borrado`, `conexionBBDD`, `lngAsesor`, `claseEmpresa`, `TipoContador`, `Logo`, `TextoPie`, `productos`) VALUES
	(1, 'paco', 'paco', 'FPP Desarrollo SL 13', '08037049K', '2016-03-21 21:33:29', '2017-03-21 21:33:31', 'Calle Badajoz 28 bajo 1', 'Alcorcón', 'Madrid', 28921, 671108309, 'fparralejo1970@yahoo.es', '', 1, 'contfpp_empresa1', NULL, NULL, 3, 'logo-bienve.png', 'hola, me llamo lola y me gusta las pastillas juanolas 4', 'SI');
