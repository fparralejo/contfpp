...
CREATE TABLE IF NOT EXISTS `empresas` (
  ...
  `TipoContador` varchar(20) DEFAULT NULL COMMENT 'SinContador=Escribe numeros libremente, solo comprobamos que no se repitan, Simple=Numerico, Compuesto=numero/Año',
...
INSERT IGNORE INTO `empresas` (`IdEmpresa`, `Nombre`, `Password`, `identificacion`, `CIF`, `fechaAlta`, `fechaVencimiento`, `direccion`, `municipio`, `provincia`, `CP`, `telefono`, `email1`, `email2`, `borrado`, `conexionBBDD`, `lngAsesor`, `claseEmpresa`, `TipoContador`, `Logo`, `TextoPie`, `productos`) VALUES
	(1, 'paco', 'paco', 'FPP Desarrollo SL', '08037049K', '2016-03-21 21:33:29', '2017-03-21 21:33:31', 'Calle Badajoz 28 bajo 1', 'Alcorcón', 'Madrid', 28921, 671108309, 'fparralejo1970@yahoo.es', NULL, 1, 'contfpp_empresa1', NULL, NULL, '1', NULL, NULL, NULL);
